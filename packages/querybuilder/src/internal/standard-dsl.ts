...
type TypeWitnesses = typeof standardDatatypes
...
>
  ...
  > => {
    ...
    return buildJsonNodeExpression(
      [base, newValue],
      {
        runtime: undefined as unknown as JsonSetOutputOf<StoredOf<Base>, Target, Next, "json.set">,
        dbType: jsonDbTypeOf(base),
        nullability: undefined as unknown as JsonNullabilityOf<JsonSetOutputOf<StoredOf<Base>, Target, Next, "json.set">>
      },
      {
        kind: "jsonSet",
        base,
  ...
  >(
    base: Base,
    target: Target & JsonInsertGuard<StoredOf<Base>, Target, NoInfer<Next>, NoInfer<InsertAfter>, "json.insert">,
    next: Next,
    options: {
  ...
  const jsonTypeOf = <Base extends JsonExpressionLike<any>>(
    ...
    [base],
    {
      runtime: undefined as unknown as JsonTypeName<StoredOf<Base>>,
      dbType: profile.textDb as TextDb,
  ...
  const jsonLength = <Base extends JsonExpressionLike<any>>(
    ...
    [base],
    {
      runtime: undefined as unknown as JsonLengthResult<StoredOf<Base>>,
      dbType: profile.numericDb as NumericDb,
      nullability: undefined as unknown as JsonNullabilityOf<JsonLengthResult<StoredOf<Base>>>
    },
    {
      kind: "jsonLength",
      value: base
  ...
  const uuidGenerateV4 = (): Expression.Scalar<
    string,
    Expression.DbType.Base<"standard", "uuid">,
    "never",
    Dialect,
    "scalar",
    never
  ...
  const nextVal = <Value extends ExpressionInput>(
    ...
    Expression.RuntimeOfDbType<Expression.DbType.Base<"standard", "bigint">>,
    Expression.DbType.Base<"standard", "bigint">,
    "never",
    Dialect,
    "scalar",
    never
  > & {
    ...
    runtime: undefined as unknown as Expression.RuntimeOfDbType<Expression.DbType.Base<"standard", "bigint">>,
    dbType: standardDatatypes.bigint(),
    nullability: "never",
    dialect: profile.dialect as Dialect,
    kind: "scalar",
