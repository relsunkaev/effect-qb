...
type ArrayColumn<Column extends AnyColumnDefinition> = ColumnDefinition<
  ReadonlyArray<BaseSelectType<Column>>,
  ReadonlyArray<BaseInsertType<Column>>,
  ReadonlyArray<BaseUpdateType<Column>>,
...
export const array = () =>
  <Column extends AnyColumnDefinition>(
    ...
    remapColumnDefinition(column as AnyColumnDefinition, {
      schema: Schema.Array(column.schema),
      metadata: {
        ...column.metadata,
        dbType: {
