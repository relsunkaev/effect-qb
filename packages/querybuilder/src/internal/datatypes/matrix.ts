...
/** PostgreSQL 16 native casts beyond identity and string I/O.
 * Verified by coercion-kind-matrix.integration.ts; extensions are not modeled. */
export const postgresAdditionalCastTargets = {
  bit: ["int4", "int8", "varbit"],
  bool: ["int4"],
  box: ["circle", "lseg", "point", "polygon"],
  bytea: [],
  cid: [],
  cidr: ["inet"],
  circle: ["box", "point", "polygon"],
  ...
  inet: ["cidr"],
  int2: ["float4", "float8", "int4", "int8", "numeric", "oid", "regclass", "regconfig", "regdictionary", "regoper", "regoperator", "regproc", "regprocedure", "regtype"],
  int4: ["bit", "bool", "float4", "float8", "int2", "int8", "money", "numeric", "oid", "regclass", "regconfig", "regdictionary", "regoper", "regoperator", "regproc", "regprocedure", "regtype"],
  int4multirange: [],
  int4range: ["int4multirange"],
  int8: ["bit", "float4", "float8", "int2", "int4", "money", "numeric", "oid", "regclass", "regconfig", "regdictionary", "regoper", "regoperator", "regproc", "regprocedure", "regtype"],
  int8multirange: [],
  ...
  macaddr8: ["macaddr"],
  money: ["numeric"],
  numeric: ["float4", "float8", "int2", "int4", "int8", "money"],
  nummultirange: [],
  numrange: ["nummultirange"],
  oid: ["int4", "int8", "regclass", "regconfig", "regdictionary", "regoper", "regoperator", "regproc", "regprocedure", "regtype"],
  path: ["polygon"],
  pg_lsn: [],
  point: ["box"],
  polygon: ["box", "circle", "path", "point"],
  regclass: ["int4", "int8", "oid"],
  regconfig: ["int4", "int8", "oid"],
  regdictionary: ["int4", "int8", "oid"],
  regoper: ["int4", "int8", "oid", "regoperator"],
  regoperator: ["int4", "int8", "oid", "regoper"],
  regproc: ["int4", "int8", "oid", "regprocedure"],
  regprocedure: ["int4", "int8", "oid", "regproc"],
...
export const postgresStringCastKinds = ["char", "name", "text", "varchar"] as const

/** Native equality pairs; existing comparison policy may be more restrictive. */
export const postgresAdditionalComparisonTargets = {
  bit: ["varbit"],
  ...
  inet: ["cidr"],
  int2: ["float4", "float8", "int4", "int8", "numeric", "oid", "regclass", "regconfig", "regdictionary", "regoper", "regoperator", "regproc", "regprocedure", "regtype"],
  int4: ["float4", "float8", "int2", "int8", "numeric", "oid", "regclass", "regconfig", "regdictionary", "regoper", "regoperator", "regproc", "regprocedure", "regtype"],
  int8: ["float4", "float8", "int2", "int4", "numeric", "oid", "regclass", "regconfig", "regdictionary", "regoper", "regoperator", "regproc", "regprocedure", "regtype"],
  interval: ["time"],
  name: ["char", "text", "varchar"],
  numeric: ["float4", "float8", "int2", "int4", "int8"],
  oid: ["int2", "int4", "int8", "regclass", "regconfig", "regdictionary", "regoper", "regoperator", "regproc", "regprocedure", "regtype"],
  regclass: ["int2", "int4", "int8", "oid", "regconfig", "regdictionary", "regoper", "regoperator", "regproc", "regprocedure", "regtype"],
  regconfig: ["int2", "int4", "int8", "oid", "regclass", "regdictionary", "regoper", "regoperator", "regproc", "regprocedure", "regtype"],
  regdictionary: ["int2", "int4", "int8", "oid", "regclass", "regconfig", "regoper", "regoperator", "regproc", "regprocedure", "regtype"],
  regoper: ["int2", "int4", "int8", "oid", "regclass", "regconfig", "regdictionary", "regoperator", "regproc", "regprocedure", "regtype"],
  regoperator: ["int2", "int4", "int8", "oid", "regclass", "regconfig", "regdictionary", "regoper", "regproc", "regprocedure", "regtype"],
  regproc: ["int2", "int4", "int8", "oid", "regclass", "regconfig", "regdictionary", "regoper", "regoperator", "regprocedure", "regtype"],
  regprocedure: ["int2", "int4", "int8", "oid", "regclass", "regconfig", "regdictionary", "regoper", "regoperator", "regproc", "regtype"],
  regtype: ["int2", "int4", "int8", "oid", "regclass", "regconfig", "regdictionary", "regoper", "regoperator", "regproc", "regprocedure"],
  text: ["char", "name", "varchar"],
  time: ["interval", "timetz"],
  timestamp: ["date", "timestamptz"],
  timestamptz: ["date", "timestamp"],
  timetz: ["time"],
  varbit: ["bit"],
  varchar: ["char", "name", "text"],
  xid: ["int2", "int4"],
} as const

export const postgresNonComparableKinds = ["json", "point", "polygon", "txid_snapshot", "xml"] as const

/** Column types with no supported MySQL 8.4 CAST target syntax. */
export const mysqlUnsupportedCastKinds = ["tinytext", "mediumtext", "longtext", "tinyint", "smallint", "mediumint", "fixed", "bool", "bit", "varbinary", "tinyblob", "mediumblob", "longblob", "geometry", "enum", "set"] as const
