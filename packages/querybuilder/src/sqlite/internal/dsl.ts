...
type SqliteUnsupportedJsonFeatureUsageError<Feature extends string> = {
  readonly __effect_qb_error__: "effect-qb: unsupported sqlite json feature"
  readonly __effect_qb_json_feature__: Feature
}

type SqliteUnsupportedJsonFeature<Feature extends string> = (
 ...
 */
type Dialect = "sqlite"
type TextDb = ReturnType<typeof sqliteDatatypes.text>
type NumericDb = ReturnType<typeof sqliteDatatypes.double>
type BoolDb = ReturnType<typeof sqliteDatatypes.boolean>
type TimestampDb = ReturnType<typeof sqliteDatatypes.timestamp>
type NullDb = Expression.DbType.Base<"sqlite", "null"> & {
  readonly family: "null"
  readonly runtime: "unknown"
  readonly compareGroup: "null"
  readonly traits: {}
}
type TypeWitnesses = typeof sqliteDatatypes

const profile: QueryDialectProfile<Dialect, TextDb, NumericDb, BoolDb, TimestampDb, NullDb, TypeWitnesses> = {
  dialect: "sqlite",
  textDb: sqliteDatatypes.text() as TextDb,
  numericDb: sqliteDatatypes.double() as NumericDb,
  boolDb: sqliteDatatypes.boolean() as BoolDb,
  timestampDb: sqliteDatatypes.timestamp() as TimestampDb,
  nullDb: {
    dialect: "sqlite",
    kind: "null",
    family: "null",
...
>
  ...
  const json = {
    ...
    length: jsonLength,
    keys: jsonKeys,
    stripNulls: jsonStripNulls as unknown as SqliteUnsupportedJsonFeature<"json.stripNulls">,
    pathExists: jsonPathExists,
    pathMatch: jsonPathMatch as unknown as SqliteUnsupportedJsonFeature<"json.pathMatch">
  }
  ...
  const uuidGenerateV4 = (): Expression.Scalar<
    string,
    Expression.DbType.Base<"sqlite", "uuid">,
    "never",
    Dialect,
    "scalar",
    never
  ...
  const nextVal = <Value extends ExpressionInput>(
    ...
    Expression.DbType.Base<"sqlite", "bigint">,
    "never",
    Dialect,
    "scalar",
    never
...
type SqliteConflictWhereError<Values> = Values & {
  readonly __effect_qb_error__: "effect-qb: sqlite does not support conflict where(...) predicates"
