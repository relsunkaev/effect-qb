...
type _AssertPostgresNicknameRuntime = Assert<
  PostgresNicknameRuntime extends (string & Brand.Brand<"accounts.nickname">) | null ? true : false
>
...
type MysqlEmailRuntime = typeof brandedMysqlEmail[Mysql.Expression.TypeId]["runtime"]
type MysqlQuotaSchema = Schema.Schema.Type<typeof brandedMysqlQuota.schema>

type _AssertMysqlEmailRuntime = Assert<
  MysqlEmailRuntime extends string & Brand.Brand<"mysql_accounts.email"> ? true : false
>
type _AssertMysqlQuotaSchema = Assert<
  MysqlQuotaSchema extends number & Brand.Brand<"mysql_accounts.quota"> ? true : false
>
