...
import { InstantStringSchema } from "../../src/internal/runtime-value.ts"
import { Column as C, Executor, Query as Q, Table } from "../../src/postgres.ts"
...
const events = Table.make(tableName, {
  ...
  happenedAt: C.custom(InstantStringSchema, Q.type.timestamptz()),
  amount: C.number(),
