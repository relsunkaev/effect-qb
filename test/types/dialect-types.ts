...
const pgExecutor = Executor.make("postgres", <PlanValue extends RootQuery.QueryPlan<any, any, any, any, any, any, any>>(
  plan: RootQuery.DialectCompatiblePlan<PlanValue, "postgres">
): Effect.Effect<RootQuery.ResultRows<PlanValue>, never, never> => {
  void plan
  return null as never
})
const myExecutor = Executor.make("mysql", <PlanValue extends RootQuery.QueryPlan<any, any, any, any, any, any, any>>(
